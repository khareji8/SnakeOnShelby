...
/**
 * @title ShelbyUSD Token (SBY-USD)
 * @dev Simple ERC20 token used as the utility token on Shelbynet Testnet.
 * Includes a public faucet function to easily mint test tokens for snake arcade.
 */
interface IERC20 {
...
contract ShelbyUSD is IERC20 {
    string public name = "ShelbyUSD";
    string public symbol = "ShelbyUSD";
    ...
    constructor() {
        owner = msg.sender;
        // Mint 1,000,000 ShelbyUSD initially to the deployer
     ...
     * Allows any user to mint exactly 10.0 ShelbyUSD to play "Snake on Shelby".
     */
    function requestFaucetTokens() external {
        uint256 faucetAmount = 10 * 10**decimals;
